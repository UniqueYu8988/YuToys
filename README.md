...
### 4️⃣ ✅ 每日任务节奏 (Daily Tasks)

把重复却重要的小事，变成每天都能轻松完成的固定节奏。

- **固定模板**：支持创建长期保留的每日任务，打开就能直接打卡。
- **连胜反馈**：自动记录当前连胜与最佳连胜，让习惯培养更有成就感。
...
- **四维数据看板**：实时汇总“达成目标”、“专注时长”、“每日任务连胜”与“运行时间”。
...
在设置版块，您可以深度定制桌面行为与提醒方式。

- **系统级集成**：
  - **整点报时**：温馨提醒时光流逝。
  - **开机自启**：已兼容本地打包场景，便于开机即用。
